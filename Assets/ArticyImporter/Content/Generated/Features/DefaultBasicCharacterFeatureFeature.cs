...
namespace Articy.Hireathconcept.Features
{
    ...
    public class DefaultBasicCharacterFeatureFeature : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.Hireathconcept.Features.DefaultBasicCharacterFeatureFeature newClone = ((Articy.Hireathconcept.Features.DefaultBasicCharacterFeatureFeature)(aClone));
            newClone.Age = Age;
        ...
        {
            Articy.Hireathconcept.Features.DefaultBasicCharacterFeatureFeature clone = new Articy.Hireathconcept.Features.DefaultBasicCharacterFeatureFeature();
